...
public class DigitalCardVisualizacao extends HttpServlet{
    ...
    @Override
    protected void digitalcardVisualizacao(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("body{ background:linear-gradient(360deg, rgb(0,0,0), #ff0044); margin-bottom: 35%;}");
        ...
        out.println(".container-card{ box-sizing: border-box; position: absolute; width: 507px; height: 300px; left: 420px; top: 280px; background:linear-gradient(360deg, rgb(0,0,0), #ff0044);border: 1px solid #000000; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px;}");
        out.println(".title-card{ margin-left: 35%; font-family: 'Roboto Mono', monospace; color: #f2f2f2; font-size: 30px;}");
        out.println(".name-card{font-family: 'Roboto Mono', monospace; color: #f2f2f2; margin-left: 8%; margin-top: 10%; font-size: 25px;}");
        out.println(".number-card{ display: flex; color: #f2f2f2; top: 200px; line-height: 92px; margin-left: 8%; font-size: 25px;}");
        out.println(".validade-card{ position: absolute; width: 63px; left: 410px; top: 60px; font-family: 'Inter'; font-style: italic; font-weight: 500; font-size: 25px; line-height: 96px; color: #f2f2f2;}");
        out.println(".cvv{ position: absolute; width: 63px; left: 410px; top: 109px; font-family: 'Inter'; font-style: italic; font-weight: 500; font-size: 25px; color: #f2f2f2; line-height: 165px;}");
        out.println("</head>");
        out.println("<body>");
        out.println("<header>");
        ...
        out.println("<p class='validade-card'>"+User.cadastroList.get(User.ID_Reference_page).getNumber_card() +"</p>");

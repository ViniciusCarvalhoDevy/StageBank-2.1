...
public class DigitalCardVisualizacao extends HttpServlet{
    ...
    protected void service(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println(".container-card{ box-sizing: border-box; position: absolute; width: 800px;height: 400px;left: 350px; top: 280px; background:linear-gradient(360deg, rgb(0,0,0), #ff0044);border: 1px solid #000000; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 25px;}");
        ...
        out.println(".cvv{ position: absolute; width: 63px; left: 410px; top: 200px; font-family: 'Inter'; font-style: italic; font-weight: 500; font-size: 20px; color: #f2f2f2; line-height: 130px;}");
        out.println("</style>");
        out.println("</head>");
        out.println("<body>");
        out.println("<header>");
        ...
        out.println("<p class='number-card'>"+User.cadastroList.get(User.ID_Reference_page).getValidity_data_card() +"</p>");

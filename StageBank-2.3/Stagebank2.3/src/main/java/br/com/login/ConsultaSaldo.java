...
public class ConsultaSaldo extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.println("<h1>Olá "+User.cadastroList.get(User.ID_Reference_page).getComplete_name()+"</h1>");
        writer.println("<h2>||SEU SALDO: R$ "+User.cadastroList.get(User.ID_Reference_page).get_Bank_Balance_Client()+"||</h2>");
